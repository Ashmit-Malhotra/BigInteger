...
int signcompare(struct BigInt s1,struct BigInt s2)
...
struct BigInt add(struct BigInt s1,struct BigInt s2){
    struct BigInt temp;
    temp.head=NULL;
    temp.length=0;
    temp.sign=0;
...
struct BigInt mul(struct BigInt s1,struct BigInt s2){
    struct BigInt temp;
    temp.head=NULL;
    temp.length=0;
    temp.sign=0;
...
struct BigInt div1(struct BigInt s1,struct BigInt s2){
    struct BigInt temp;
    temp.head=newNode(0);
    temp.length=0;
    temp.sign=0;
